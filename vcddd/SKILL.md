...
| `/vcddd-frontend-design` | D²·⁶ — 前端设计指导 | 使用 google-design-md 完成前端设计规范 | `steps/FRONTEND-DESIGN/` |
...
- 前端页面实现必须引用 `docs/vcddd/frontend/` 中经 `google-design-md` 完成/校准的设计规范，不允许脱离指导文件自由发挥
