...
> [!abstract] 主写身份
> 你是业务 Leader。本文只导航业务确立事实、登记各自产出成熟度和直接链接；不得复制或改写各能力已经拥有的业务与 Domain 结论。
...
| 事实类型 | 权威入口 | 状态 | 拥有角色 |
|---|---|---|---|
| 业务定义 | [[{{业务定义笔记}}]] | `draft` | 业务 Leader：业务定义能力 |
| 领域地图 | [[{{领域地图笔记}}]] | `draft` | 业务 Leader：Domain 发现能力 |
| Domain | [[{{领域地图笔记}}]] | `draft` | 业务 Leader：各 Domain 建模能力 |
| 业务组合 | [[{{业务组合笔记}}]] | `draft` | 业务 Leader：业务组合能力 |
