...
**阅读身份：** VCDDD 主控 Agent 使用本文选择角色、建立上下文连接和登记产出；用户直接调用的主专业 Agent 使用本文确定当前能力边界。不要以主控身份完成专业工作。
...
不要建立一个会重新汇总和思考的“业务确立总 Agent”。用户可以在自己创建的当前对话直接选择专业角色，也可以进入主控连接的专业对话；同一职责、同一业务目标或同一 Domain 的修正优先续用原对话。
